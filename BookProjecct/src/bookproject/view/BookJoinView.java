...
public class BookJoinView {
	...
	public BorderPane getSignUp() {
		...
		signup.setOnAction(e -> {
			...
			// ObservableList<UserVO> list = controller.getResult(idtf.getText(),
			// pwtf.getText(), emailtf.getText());

			// 회원가입 마이바티스로 수정...
			ObservableList<UserVO> listMB = controller.getResultMB(idtf.getText(), pwtf.getText(), emailtf.getText());
