...
public class UpdateBookView {
	...
	public BorderPane setBook(String idID, String bookISBN, String searchKeyword) {
		...
		upDateBook.setOnAction(e -> {
			 ...
			 * controller.updateBookController(bsidtf.getText() , btitletf.getText(),
			 * bdatetf.getText(), Integer.parseInt(bpagetf.getText()),
			 * Integer.parseInt(bpricetf.getText()), bauthortf.getText(),
			 * btranslatortf.getText(), bsupplementltf.getText(), bpublishertf.getText(),
			 * Integer.parseInt(BookRentaltf.getText()), bookISBN);
			 */

			// 마이바티스로 책 수정하기
			ObservableList<BookVO> listMB = controller.updateBookControllerMB(bsidtf.getText(), btitletf.getText(),
					bdatetf.getText(), Integer.parseInt(bpagetf.getText()), Integer.parseInt(bpricetf.getText()),
					bauthortf.getText(), btranslatortf.getText(), bsupplementltf.getText(), bpublishertf.getText(),
					Integer.parseInt(BookRentaltf.getText()), bookISBN);
