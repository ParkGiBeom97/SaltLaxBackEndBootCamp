...
public class BookDAO {
	...
	public ObservableList<BookVO> selectAllBook(String text) {
		...
		try {
			...
			for(HashMap<String, Object> map : list) {
				BookVO book = new BookVO((String)map.get("bisbn"),
						(String)map.get("btitle"), (String)map.get("bauthor"),
						(int)map.get("bprice"), (int)map.get("bpage"), (String)map.get("bpublisher"));
	...
	public UserVO loginUserMB(String text, String text2) {
		...
		try {
			...
			for(HashMap<String, Object> map : list) {
				...
				listO = new UserVO((String)map.get("user_ID"),
						(String)map.get("user_PW"));
			}
		} catch (Exception e) {
	...
	public ObservableList<UserVO> getUserInfoMB(String idID) {
		...
		try {
			...
			for(HashMap<String, Object> map : list) {
				UserVO user = new UserVO((String)map.get("user_ID"),
						(String)map.get("user_PW"), (String)map.get("user_EM"),
						(int)map.get("user_point"));	
				listO.add(user);
			}
	...
	public ObservableList<LogVO> getLogMB() {
		...
		try {
			...
			for(HashMap<String, Object> map : list) {
				LogVO logMB = new LogVO((String)map.get("bisbn"), (String)map.get("user_ID"), (String)map.get("btitle"),
						(Date)map.get("rentalDay"), (Date)map.get("returnDay"));
				listMB.add(logMB);
			}
		} catch (Exception e) {
			e.printStackTrace();
