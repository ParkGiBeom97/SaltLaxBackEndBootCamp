...
public class AddBookController {
	...
	public ObservableList<BookVO> addBookController(String text, String text2, String text3, int parseInt,
		...
		ObservableList<BookVO> list = service.addBookService(text, text2, text3, parseInt, parseInt2, text4, text5,
				text6, text7, parseInt3);
	...
	public ObservableList<BookVO> addBookControllerMB(String text, String text2, String text3, int parseInt,
		...
		BookService service = new BookService();
		ObservableList<BookVO> listMB = service.addBookServiceMB(text, text2, text3, parseInt, parseInt2, text4, text5,
				text6, text7, parseInt3);
